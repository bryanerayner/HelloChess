...
on getPropertyDescriptionList me
  ...
  addProp list, #pBehavior, [#comment: "Link behavior - Next, go to next slide. Link - go to linked slide. Pause - Stay on current frame after done.", #format: #string, #default: "Next"]
